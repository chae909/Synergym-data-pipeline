...
list_base_url = "https://terms.naver.com/list.naver?cid=51034&categoryId=51034&page={}"
...
df.to_csv("naver_terms_yoga.csv", index=False, encoding="utf-8-sig")
print("'naver_terms_yoga.csv' 저장됨.")
